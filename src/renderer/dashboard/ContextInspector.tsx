...
export function ContextInspector(props: {
  ...
  return (
    <aside className={cn("absolute right-0 top-0 z-50 flex h-full w-[380px] max-w-[92vw] flex-col bg-[#f9f9fa] shadow-[-20px_0_60px_rgba(0,0,0,0.08)] transition-transform duration-300", props.open ? "translate-x-0" : "translate-x-full")}>
